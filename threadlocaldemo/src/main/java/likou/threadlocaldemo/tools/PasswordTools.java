 ...
 * 
 * 类说明: 加密, 解密工具.
 * @author BrandoLv 2018-5-11 上午11:21:17
 */
public class PasswordTools {

    /**加密Key_1**/
    private static String PASSWORD_KEY_1 = "1";
    /**加密Key_2**/
    private static String PASSWORD_KEY_2 = "2";
    /**加密Key_3**/
    private static String PASSWORD_KEY_3 = "3";

	
	/**
	 * 
	 * 方法说明: 加密.
	 * @author Lyq 2015-5-11 下午12:02:48
	 * @param data
	 * @return
	 */
	public static String strEnc(String data) {
		return strEnc(data, PASSWORD_KEY_1, PASSWORD_KEY_2, PASSWORD_KEY_3);
	}
	
	/**
	 * 方法说明: 解密.
	 * @author Lyq 2015-5-11 下午2:36:40
	 * @param data
	 * @return
	 */
	public static String strDec(String data) {
		return strDec(data, PASSWORD_KEY_1, PASSWORD_KEY_2, PASSWORD_KEY_3);
	}

	/**
	 * 
	 * 方法说明: 加密
	 * @author Lyq 2015-5-11 上午11:24:18
	 * @param data 文本
	 * @param firstKey 密匙1
	 * @param secondKey 密匙2
	 * @param thirdKey 密匙3
