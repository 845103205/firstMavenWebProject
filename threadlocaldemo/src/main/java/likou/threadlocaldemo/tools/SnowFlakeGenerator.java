...
/**
 * 方法说明: 雪花算法
 * @author BrandoLv 2020-10-19 14:10
 */
public class SnowFlakeGenerator {
    ...
    public static synchronized SnowFlakeGenerator getInstance() {
        if(instance == null) {
            instance = new SnowFlakeGenerator(1L, 1L, 12L);
        }
        return instance;
    }
    ...
    public static long generator() {
        return SnowFlakeGenerator.getInstance().nextId();
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 3000000; i++) {
            System.out.println(SnowFlakeGenerator.generator());
        }
    }
